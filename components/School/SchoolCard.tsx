    ...
    >
      <div className="flex flex-row justify-between h-max ">
        ...
        <div className="w-[75%] pl-6">
          ...
          <button className="font-bold hover:underline SchoolName" onClick={onOpen}>{schoolName}</button>


          <Modal size="2xl" motionPreset="slideInRight" isOpen={isOpen} onClose={onClose} >
            <ModalOverlay 
            ...
            <ModalContent 
              ...
              className="r rounded-full border-1">             
              <ModalBody className="">
                  ...
                  <div className="pt-3 grid-cols-[50%_50%] grid" >
                    ...
                    <div className=" w-max ">
                      <div className="stars-text flex flex-row pb-[20px]">
                        ...
                        {renderStars(rating)} 
                        </div> <div className="pl-[5px] text-dark-blue pt-[4px]">(x ratings)</div>
                      </div>
          ...
          <div className="pt-2 grid-cols-[50%_50%] grid">
            <Link
              ...
              rel="noreferrer"
            >
              <BiMap className="my-auto mr-2 fill-green translate-y-[-2px] scale-[115%] hover:scale-[130%] duration-200" />
            ...
            >
              {!favorite ? (
                <BsBookmark className=" w-[25%] my-auto fill-green translate-y-[-2px]" />
              ) : (
                <BsBookmarkFill className=" w-[25%] my-auto fill-green translate-y-[-2px]" />
              )}
      ...
      <div>
        ...
        <style>{cutoff}</style>  {/**limits the show lines to 2, adds ... */}     
      </div>
    </div>
  </>
  );
